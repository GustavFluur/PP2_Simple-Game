...
The emojis were taking from globle and function key the "fn" button Macbook air [image](/assets/images/fn.globe.webp) and once you click on it then this image will emerge: [emoji-selection](/assets/images/fn.clicked.png).